---
name: harness-adapter-opencode
description: >-
  Use after harness-adapters when the resolved harness is opencode.
...
Load this skill after `harness-adapters` when the resolved harness is `opencode`.
