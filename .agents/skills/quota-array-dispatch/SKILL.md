...
## Selection rules moved here from AGENTS.md section 4

These rules were always-loaded in `AGENTS.md` section 4 and now live here; they bind every profile-array resolution.
