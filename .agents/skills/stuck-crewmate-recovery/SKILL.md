...
Load `harness-adapters`, then the adapter-detail skill it routes to, before a resume command or a harness-specific skill invocation, and whenever the adapter's own quirks matter.
