...
config/cockpit-layout  Herdr cockpit fleet-banner direction, order, and ratio; LOCAL, gitignored, and not inherited; absent means the default full-width 28% banner above the supervisor; see docs/configuration.md "Cockpit fleet layout"
