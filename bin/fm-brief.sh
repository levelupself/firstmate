...
Include this artifact-style constraint in \`--intent\`: every generated artifact, including risk rationales and fix summaries, must use role-neutral prose with no second person and no captain, user, firstmate, or crewmate role nouns.
