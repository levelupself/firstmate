...
family_for_basename() {
  case "$1" in
    ...
    fm-model-bench.test.sh|fm-operational-input.test.sh|\
    ...
    fm-watcher-lock.test.sh|fm-inactive-reconcile.test.sh|fm-context-watch.test.sh)
      printf '%s\n' watcher-wake-lock
      ;;
    ...
    fm-public-followup-herdr-isolation-e2e.test.sh|\
    ...
    fm-muse-signals-live-e2e.test.sh|fm-model-bench-live-e2e.test.sh|\
    ...
    fm-tmux-agent-liveness.test.sh|fm-codex-busy-owner.test.sh|\
    ...
    fm-spawn-pool-slot-binding.test.sh|fm-spawn-reacquire.test.sh|\
