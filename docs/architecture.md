...
[`bin/fm-pr-merge.sh`](../bin/fm-pr-merge.sh)'s header owns the post-mutation confirmation retry budget, deadline semantics, and verification required after a timeout.
