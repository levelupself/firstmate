...
The landed-work guarantee never lived in that row, so cleanup falls back to evidence retention cannot delete - its own completed landed-work proof, or an identity-bound merged-PR or local-landing receipt or completed scout report - and refuses when neither exists, because absence of a record is never permission to discard.
