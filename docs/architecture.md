...
Accepting the done-archive row instead was also rejected because it moves the record-existence dependency to another file while retaining unverified text as authority.
