...
| portable serial 1-4 | 30 | The old 15-minute cap killed passing shards before their true duration was known; use completed per-shard timing artifacts before tightening this generous headroom. |
